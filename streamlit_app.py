...
# Check if authentication status and render appropriate UI
if authentication_status:
    st.sidebar.title(f"Welcome {name}")
    if username == "student":
        st.title("Student Chatbot Interface")
        st.write("This is the interface for students to interact with the chatbot.")
        st.write("This is the interface for students to interact with the chatbot.")
        # Add student interface code here
